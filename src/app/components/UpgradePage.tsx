              ...
              <div className="mt-5 grid grid-cols-3 gap-3 sm:gap-6 bg-white/10 rounded-2xl px-4 sm:px-7 py-4">
                <div className="text-left">
                  ...
                  <div className="w-full h-1.5 rounded-full bg-white/20">
                    <div className="h-full rounded-full transition-all" style={{ width: `${linkPct}%`, background: linkPct >= 90 ? '#DC2626' : '#F87171' }} />
                  </div>
                </div>
                <div className="text-left">
                  <div className="flex items-center justify-between mb-1 gap-1">
                  ...
                  <div className="w-full h-1.5 rounded-full bg-white/20">
                    <div className="h-full rounded-full transition-all" style={{ width: `${boardPct}%`, background: boardPct >= 90 ? '#DC2626' : '#F87171' }} />
                  </div>
                </div>
                <div className="text-left">
                  <div className="flex items-center justify-between mb-1 gap-1">
                  ...
                  <div className="w-full h-1.5 rounded-full bg-white/20">
                    <div className="h-full rounded-full transition-all" style={{ width: `${storagePct}%`, background: storagePct >= 90 ? '#DC2626' : '#F87171' }} />
                  </div>
                </div>
              </div>
            </div>
